...
# Celtics either lose or win. Copy this example code to use 
# within the `replicate` function.
simulated_games <- sample(c("lose","win"), 4, replace = TRUE, prob = c(0.6, 0.4))

# The variable 'B' specifies the number of times we want the simulation 
# to run. Let's run the Monte Carlo simulation 10,000 times.
B <- 10000
